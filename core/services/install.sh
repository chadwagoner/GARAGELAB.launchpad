...
### START SERVICE(S)
docker compose -f $service_path/core/compose.yaml --env-file .env --env-file .env.komodo --env-file .env.mongo --env-file .env.pocket-id --env-file .env.tsbridge up -d #> /dev/null 2>&1
